...
main() {
  ...
  test(
    "Removing last appearance should work",
    () {
      var character = Character(PointInTimeId());
      character.lastAppearance = oldLastAppearance;
      var command = UpdateLastAppearanceCommand(character, null);
  ...
  test(
    "Undoing of removal of last appearance should work",
    () {
      var character = Character(PointInTimeId());
      character.lastAppearance = oldLastAppearance;
      var command = UpdateLastAppearanceCommand(character, null);
      ...
      expect(character.lastAppearance, oldLastAppearance);
    },
  );

  test(
    "Redoing removal of last appearance should work",
    () {
      var character = Character(PointInTimeId());
      character.lastAppearance = oldLastAppearance;
      var command = UpdateLastAppearanceCommand(character, null);
